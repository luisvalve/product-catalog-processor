...
INPUT_PRODUCT_FILE = DATA_DIR / "products.csv"
INPUT_VEHICLE_FILE = DATA_DIR / "vehicle_compatibility.xlsx"
BRAND_MAPPINGS_FILE = DATA_DIR / "brand_abbreviations.csv"
OUTPUT_FILE = DATA_DIR / "products_merged.csv"
